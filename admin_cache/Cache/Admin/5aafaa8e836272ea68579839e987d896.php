...
<script src="/wbshop/admin/Public/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(/wbshop/admin/Public/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <ul>
    <form action="<?php echo U('Main/main');?>" method="post" >
    ...
    <div class="loginbm">版权所有  2013  <a href="http://www.uimaker.com">0o0ooo.com</a>  仅供学习交流，勿用于任何商业用途</div>
